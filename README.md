...
<h4> In line with the Test Case given using TestNG, the "www.a101.com.tr" Url is to test whether the scenarios prepared to test the user experiences and reflect the encountered situations meet the targets in line with the acceptance criteria. </h4> 
